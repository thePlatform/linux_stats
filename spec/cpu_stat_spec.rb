...
CENTOS_5_DATA = 'cpu  53054583 690 12818403 154625262 985643 2316151 7762682 0'
CENTOS_6_DATA = 'cpu0 2533647 9153 430212 109730676 569761 18858 73181 0 0'

describe 'CPU Stats Class' do

  it 'should parse Centos 5 data' do
    cpu_stat = CPU::Stats.new(CENTOS_5_DATA)
    expect(cpu_stat.name).to eq 'cpu'
    expect(cpu_stat.user).to eq 53054583
    expect(cpu_stat.nice).to eq 690
  end

  it 'should parse Centos 6 data' do
    cpu_stat = CPU::Stats.new(CENTOS_6_DATA)
