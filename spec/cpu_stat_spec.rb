...
CENTOS_5_CPU_DATA = 'cpu  53054583 690 12818403 154625262 985643 2316151 7762682 0'
...
describe 'CPU Stats Class' do
  ...
  it 'should parse Centos 5 data' do
    cpu_stat = CPU::Stats.new(CENTOS_5_CPU_DATA)
  ...
  it 'should parse Centos 6 data' do
    cpu_stat = CPU::Stats.new(CENTOS_6_CPU_DATA)
